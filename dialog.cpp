...
Dialog::Dialog(QWidget *parent) :
    ...
    action->setText(QString::fromLocal8Bit("设置皮肤"));

    action1->setIcon(QIcon(":/image/image/pf2.png"));
    action1->setText(QString::fromLocal8Bit("棕色"));
    action2->setIcon(QIcon(":/image/image/pf5.png"));
    action2->setText(QString::fromLocal8Bit("晨曦"));
    action3->setIcon(QIcon(":/image/image/pf3.png"));
    action3->setText(QString::fromLocal8Bit("天空"));
    action4->setIcon(QIcon(":/image/image/pf4.png"));
    action4->setText(QString::fromLocal8Bit("自定义"));
    ...
    Action->setText(QString::fromLocal8Bit("设置透明度"));
